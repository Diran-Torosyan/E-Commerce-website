...
public class Item {
    ...
    public void readFile() throws FileNotFoundException {
        Scanner filesc = new Scanner(new File(getClass().getClassLoader().getResource("itemstock.txt").getFile())); //scans text file
        ...
        try {
            File file = new File(getClass().getClassLoader().getResource("itemstock.txt").getFile());
