...
public class CheckoutPage extends JFrame {
    ...
    public CheckoutPage(Cart cart, User user) {
        ...
        enterButton.addActionListener(e -> {
            if (isValidCreditCard(cardNumField.getText())) {
                this.cardNumber = cardNumField.getText();
                this.cardCVV = cardCVVField.getText();
                this.expirationDate = expirationField.getText();

                storePurchaseDetails(user.getEmail(), total, cardNumber, cardCVV, expirationDate);
    ...
    /**
     * Stores the purchase details, including the user's email, total amount, items purchased, and credit card info in a text file.
     * 
     * @param email The user's email address.
     * @param total The total amount of the purchase.
     * @param cardNumber The credit card number used for the purchase.
     * @param cardCVV The CVV of the credit card.
     ...
     */
    private void storePurchaseDetails(String email, double total, String cardNumber, String cardCVV, String expirationDate) {
     ...
     * 
     * @exception MessagingException prompts message to inform user if sending email receipt fails
     */
