...
public class Item {
    ...
    public boolean readFile(int itemId) {
        String filePath = "src/main/resources/itemstock.txt";
        ...
        try (BufferedReader br = new BufferedReader(new FileReader(itemFile))) {
            ...
            while ((line = br.readLine()) != null) {
                ...
                if (fields.length == 13 && Integer.parseInt(fields[0]) == itemId) {
                    fields[7] = String.valueOf(smallStock);    
                    fields[8] = String.valueOf(mediumStock);  
                    fields[9] = String.valueOf(largeStock);   
                    fields[10] = String.valueOf(xlargeStock);  
