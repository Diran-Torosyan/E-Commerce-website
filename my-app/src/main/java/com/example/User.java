...
public class User {
    ...
    public void adminInfo() {
        ...
        /**
     * Checks if the provided admin credentials match any in the admin.txt file.
     * 
    ...
    public boolean adminLoginCheck(String username, String password) {
        ...
        try (Scanner scanner = new Scanner(adminFile)) {
            while (scanner.hasNextLine()) {
                String fileUsername = scanner.nextLine().trim();
                if (fileUsername.isEmpty()) continue;

                if (scanner.hasNextLine()) {
                    String filePassword = scanner.nextLine().trim();
                    if (filePassword.isEmpty()) continue;
